...
from PyQt5.QtWidgets import (QApplication, QWidget, QHBoxLayout, QVBoxLayout, QGroupBox, QButtonGroup, QRadioButton,
                             QPushButton, QLabel)
...
questions_list.append(
   Question("Какого цвета нет во флаге России?", "красный", "зеленый", "белый", "синий"))
questions_list.append(
   Question("Из чего состоит гибсокартон ", "из картона", "из гибса", "из строительной бумаги"))
...
def next_question():
    ...
    q = questions_list[window.car_queston]
    ask(q)
